...
const SearchBar = ({data}) => {
  ...
  return (
      ...
      <form onSubmit={onSearchHandler} className='max-w-xl w-full md:h-14 h-12 flex items-center bg-white border border-gray-500/20 rounded'>
        ...
        <input onChange={e=>setInput(e.target.value)} value={input} type="text" placeholder='search for the course' className='w-full h-full outline-none text-gray-500/80'/>
